...
import {
  ...
  forgetPassword,
  NurseLogin,
  PatientLogin, // Import PatientLogin action
  ...
  const HandleSubmit = (e) => {
    ...
    if (formvalue.ID !== "" && formvalue.password !== "") {
      if (placement === "Nurse") {
        ...
        dispatch(NurseLogin(data)).then(handleLoginResponse);
      } else if (placement === "Doctor") {
        let data = {
          ...formvalue,
          docID: formvalue.ID,
        };
        dispatch(DoctorLogin(data)).then(handleLoginResponse);
      } else if (placement === "Admin") {
        let data = {
          ...formvalue,
          adminID: formvalue.ID,
        };
        dispatch(AdminLogin(data)).then(handleLoginResponse);
      } else if (placement === "Patient") {
        // let data = {
        //   ...formvalue,
        //   patientID: formvalue.ID,
        // };
        // dispatch(PatientLogin(data)).then(handleLoginResponse);
        setLoading(false);
      navigate("/imageuploadpage", { state: { userType: "patient" } });
