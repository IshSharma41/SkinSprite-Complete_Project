...
export const CreateReport = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "http://localhost:7000/reports/create",
      data
    );
    console.log(res);
    return res.data;
...
export const GetBeds = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get("http://localhost:7000/beds");
    console.log(res);
    dispatch({
...
export const CreateBooking = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      `http://localhost:7000/appointments/create`,
      data
    );
    console.log(res);
...
export const GetSingleBed = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.post(
      "http://localhost:7000/beds/single",
      data
    );
    // console.log(res);
    return res.data;
...
export const dischargePatient = (data) => async (dispatch) => {
  try {
    ...
    const res = await axios.put(
      `http://localhost:7000/beds/discharge`,
      data
    );
    console.log(res);
    // return res.data;
...
export const GetAllAppointment = () => async (dispatch) => {
  try {
    ...
    const res = await axios.get(
      `http://localhost:7000/appointments`
    );
    // console.log(res.data);
    // return res.data;
    dispatch({
